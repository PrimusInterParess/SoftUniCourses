...
public class UserService : IUserService
{
    ...
    public UserService(IValidationService validationService, IRepository repo,ITripService tripService)
    {
    ...
    {
        return this.repo.All<User>().FirstOrDefault(u => u.Id == userId);
    }

    public UserAuthenticatedViewModel GetIsAuthenticatedUserModel()
    {
        var model = new UserAuthenticatedViewModel()
        {
            IsAuthenticated = true,
            Trips = this.tripService.GetAllTrips().ToList()
