...
namespace Exam.MobileX
{
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            Vehicle car2 = new Vehicle("b", "VW", "Golf", "Germany", "blue", 150, 20000, false);
            Vehicle car3 = new Vehicle("c", "VW", "T-Rock", "Germany", "orange", 180, 17000, false);
            Vehicle car4 = new Vehicle("d", "VW", "Arteon", "Germany", "green", 250, 55000, true);
            Vehicle car5 = new Vehicle("e", "VW", "Toareg", "Germany", "white", 200, 45000, true);
            Vehicle car6 = new Vehicle("f", "Audi", "A4", "Germany", "navy blue", 135, 10000, false);
            Vehicle car7 = new Vehicle("g", "Audi", "A8", "Germany", "gold", 250, 60000, true);
